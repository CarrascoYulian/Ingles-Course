...
const buttonVariants = cva(
  [
    'inline-flex items-center justify-center gap-2 whitespace-nowrap text-center max-w-full leading-tight',
  ...
  ],
  {
    variants: {
      ...
      size: {
        xs: 'px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg text-caption font-bold',
        sm: 'px-3 py-1.5 sm:px-3.5 rounded-lg text-meta font-bold',
        md: 'px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-xl text-body-sm font-bold',
        lg: 'px-4 py-2.5 sm:px-5 sm:py-3 rounded-xl text-body font-extrabold',
        block: 'w-full px-4 py-3 sm:px-5 sm:py-3.5 rounded-2xl text-body-lg font-extrabold',
        square: 'size-8 rounded-lg text-label font-extrabold p-0',
        drop: 'w-full px-4 py-4 sm:px-5 sm:py-5 rounded-2xl text-body-sm font-bold',
      },
    },
